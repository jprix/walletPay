<script>
	...
	const enable = () => defaultEvmStores.setProvider('https://rinkeby.infura.io/v3/7bc8abe60fb941df8cfba6d3a4264dde')
	const enableBrowser = () => defaultEvmStores.setProvider('https://rinkeby.infura.io/v3/7bc8abe60fb941df8cfba6d3a4264dde')
	...
	onMount(
			async () => {
				message = 'Connecting to Ethereum Testnet Rinkby'
				await defaultEvmStores.setProvider('https://rinkeby.infura.io/v3/7bc8abe60fb941df8cfba6d3a4264dde')
				message = ''
			})
...
<main>
	...
	{#if $web3.version}
		<p>
			<button on:click="{enable}">Connect to Bison Trails Rinkby</button>
		</p>

		<p>
			<button on:click="{enableBrowser}">Connect to Bison Trails Rinkby </button> (eg Coinbase)
		</p>
	{:else}
